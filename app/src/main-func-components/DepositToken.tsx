...
const DepositToken = () => {
  ...
  const [selectedToken, setSelectedToken] = useState('USDC');
    ...
    const handleDeposit = async (amount: number, mintAddress:string, merchantAddress:string) => {
        if (!wallet) {
           ...
           <div className="space-y-2">
                ...
                type='number'
                      ...
                      <Button 
                          variant="outline" 
            className="w-full"
            onClick={()=>handleDeposit(depositAmount, "Gh9ZwEmdLJ8DscKNTkTqPbNwLNNBjuSzaG9Vp2KGtKJr", merchantAddress)}
                      >
                        Deposit
                      </Button>
                    </CardContent>
