...
const VaultDetails = () => {
  ...
  return (
      <div>
          ...
          <Button onClick={()=>{getVaultDetails(clientAddress, merchantAddress, "Gh9ZwEmdLJ8DscKNTkTqPbNwLNNBjuSzaG9Vp2KGtKJr")}}>Get Vault Details</Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-mono text-vault-green font-semibold">{vaultBalance} USDC</p>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  <span className="text-muted-foreground text-sm">Merchant Fee:</span>
                  <p className="text-foreground">90.00%</p>
                </div>
                <div>
